...
async function dependencyInjectionContainerPlugin(
    ...
    const microsoftClientId = await ssmClient.getMicrosoftClientId()
    ...
    const dependencyInjectionContainer = (): AwilixContainer => {
        ...
        container.register({
            microsoftAuthClient: awilix.asValue(
                new ConfidentialClientApplication({
                    auth: {clientId: microsoftClientId, clientSecret: microsoftClientId}}
                ),
            ),
        })
